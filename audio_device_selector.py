...
microphone = "to be decided"
speaker = "to be decided"
headphone_speaker = 6
headphone_microphone = 1
...
def device_selection(p):
    ...
    return stream, channelcount, device_info, defaultframes, int(device_info["defaultSampleRate"])